...
function aplicacao_2() {
  const cliente5 = new Cliente_1.default(
    "100.000.000-00",
    "Euclides Cunha",
    "(41)99999-9999",
    true
  );
  const endereco1 = new Endereco_1.default(
    "80.111-001",
    "rua a",
    "555",
    "casa",
  ...
  const endereco2 = new Endereco_1.default(
    "80.222-001",
    "rua b",
    "444",
    "casa",
  ...
  const endereco3 = new Endereco_1.default(
    "80.333-001",
    "rua c",
    "333",
    "casa",
